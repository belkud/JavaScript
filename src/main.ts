...
// let countries_letter = ''

console.log(massive_with_countries);
...
write_countries.addEventListener('keydown',(e)=> {
    ...
    // console.log(title_countries.childElementCount);
    
})

title_countries.addEventListener('click', (e)=> {
    let country = e.target as any
    write_countries.value = country.innerHTML
